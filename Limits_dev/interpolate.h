...
TH2D* interpolate(const TH2D* hist, std::string firstInterpolationDirection);
// increases binning by factor of two and interpolates in specified direction
TH2D* rebin(TH2D* hist, std::string firstInterpolationDirection);
...
TH2D* rebin(TH2D* hist, std::string firstInterpolationDirection)
{
  ...
  TH2D* histRebinnedInterpolated = interpolate(histRebinned, firstInterpolationDirection);
