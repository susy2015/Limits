...
def fillAsymptoticLimits(config, limfilename, excfilename, interpolate):
    ...
    hlumi = TH2D('hlumi', '', nbinsx, minmstop, maxmstop, nbinsy, minmlsp, maxmlsp)
    hlumiup = TH2D('hlumiup', '', nbinsx, minmstop, maxmstop, nbinsy, minmlsp, maxmlsp)
    hlumidown = TH2D('hlumidown', '', nbinsx, minmstop, maxmstop, nbinsy, minmlsp, maxmlsp)
